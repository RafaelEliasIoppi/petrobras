...
export function useErros(agendarRevisaoCallback) {
  if (instance) {
    return instance;
  }
  ...
  instance = { erros, editandoErro, totalErros, errosAgrupados, carregarErros, novoErro, salvarErro, cancelarErro: () => editandoErro.value = null, editarErro: (e) => editandoErro.value = { ...e }, removerErro, agendarRevisaoCallback };
  return instance;
}