...
// A função de agendar revisão vem do diário, então precisamos dos dois composables.
const { agendarRevisao } = useDiario();
const {
  totalErros, errosAgrupados, editandoErro, carregarErros,
  novoErro, salvarErro, cancelarErro, editarErro, removerErro
} = useErros(agendarRevisao);
